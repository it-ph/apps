...
<head>
    ...
    <title>Personiv Apps | IT Department</title>
</head>
<body>
...
.container1 { padding-top: 62.5%; position: absolute; width: 100%; bottom: 0; left: 0; }
.container1.active { cursor: ew-resize; }
...
<div class="container"><div class="container1">
    <div class="row">
        <div class="col-md-12"  >
    <img class="background" src="{{ asset('assets/img/it-department/background.jpg') }}">

    <img class="cloud-bg" src="{{ asset('assets/img/it-department/cloud-bg.png') }}">
    <img class="cloud-bg2" src="{{ asset('assets/img/it-department/cloud-bg.png') }}">

    <div class="castle-container">
        <div class="castle">
            <div class="brleg">
                <img class="brfoot" src="{{ asset('assets/img/it-department/brfoot.png') }}" />
                <img class="brbottom" src="{{ asset('assets/img/it-department/brbottom.png') }}" />
            </div>
            <div class="frleg">
                <img class="frfoot" src="{{ asset('assets/img/it-department/frfoot.png') }}" />
                <img class="frbottom" src="{{ asset('assets/img/it-department/frbottom.png') }}" />
            </div>
            <img class="chimney3" src="{{ asset('assets/img/it-department/chimney3.png') }}" />
            <img class="treehouse" src="{{ asset('assets/img/it-department/treehouse.png') }}" />
            <div class="houses-group">
                <img class="point6" src="{{ asset('assets/img/it-department/point6.png') }}" />
                <img class="point5" src="{{ asset('assets/img/it-department/point5.png') }}" />
                <img class="point4" src="{{ asset('assets/img/it-department/point4.png') }}" />
                <img class="houses" src="{{ asset('assets/img/it-department/houses.png') }}" />
            </div>
            <img class="chimney2" src="{{ asset('assets/img/it-department/chimney2.png') }}" />
            <img class="chimney1" src="{{ asset('assets/img/it-department/chimney1.png') }}" />
            <img class="wing" src="{{ asset('assets/img/it-department/wing.png') }}" />
            <div class="mound-group">
                <img class="antenna" src="{{ asset('assets/img/it-department/antenna.png') }}" />
                <img class="point3" src="{{ asset('assets/img/it-department/point3.png') }}" />
                <img class="point2" src="{{ asset('assets/img/it-department/point2.png') }}" />
                <img class="point1" src="{{ asset('assets/img/it-department/point1.png') }}" />
                <img class="mound" src="{{ asset('assets/img/it-department/mound.png') }}" />
            </div>
            <img class="wind" src="{{ asset('assets/img/it-department/wind.png') }}" />
            <img class="cannon" src="{{ asset('assets/img/it-department/cannon.png') }}" />
            <img class="main" src="{{ asset('assets/img/it-department/main.png') }}" />
            <div class="blleg">
                <div class="blbottom-group">
                    <img class="blfoot" src="{{ asset('assets/img/it-department/flfoot.png') }}" />
                    <img class="blbottom" src="{{ asset('assets/img/it-department/flbottom.png') }}" />
                </div>
                <img class="bltop" src="{{ asset('assets/img/it-department/fltop.png') }}" />
            </div>
            <img class="blcover" src="{{ asset('assets/img/it-department/blcover.png') }}" />
            <img class="knob" src="{{ asset('assets/img/it-department/knob.png') }}" />
            <img class="tele" src="{{ asset('assets/img/it-department/tele.png') }}" />
            <img class="telecover" src="{{ asset('assets/img/it-department/telecover.png') }}" />
            <div class="flleg">
                <div class="flbottom-group">
                    <img class="flfoot" src="{{ asset('assets/img/it-department/flfoot.png') }}" />
                    <img class="flbottom" src="{{ asset('assets/img/it-department/flbottom.png') }}" />
                </div>
                <img class="fltop" src="{{ asset('assets/img/it-department/fltop.png') }}" />
            </div>
            <img class="flcover" src="{{ asset('assets/img/it-department/flcover.png') }}" />
        </div>
    </div>

    <img class="foreground" src="{{ asset('assets/img/it-department/foreground.png') }}">

    <div class="clouds">
        <img class="cloud-shadow1" src="{{ asset('assets/img/it-department/cloud_shadow-1.png') }}">
        <img class="cloud-shadow2" src="{{ asset('assets/img/it-department/cloud_shadow-1.png') }}">
        <img class="cloud-shadow3" src="{{ asset('assets/img/it-department/cloud_shadow-1.png') }}">
        <img class="cloud1" src="{{ asset('assets/img/it-department/cloud-1.png') }}">
        <img class="cloud2" src="{{ asset('assets/img/it-department/cloud-1.png') }}">
        <img class="cloud3" src="{{ asset('assets/img/it-department/cloud-2.png') }}">
        <img class="cloud4" src="{{ asset('assets/img/it-department/cloud-1.png') }}">
        <img class="cloud5" src="{{ asset('assets/img/it-department/cloud-2.png') }}">
    </div>
...
<script src="{{ asset('assets/img/it-department/TweenMax.min.js') }}"></script>
<script>
     document.addEventListener('contextmenu', function(event){alert('Thank you for visiting Personiv Apps'); event.preventDefault()});
